...
export default function Text() {
    return (
        <div class="text-container">
            <p>I decided to work in the tech industry after a few years of soul-searching, looking for a line of work
        ...
        <p>Those reservations led me to start thinking about other careers that I could find fulfilling, and
            ...
            with other skills learned during previous employment and academic work.</p>
        <a href="https://northcoders.com/">Northcoders Bootcamp</a>
        </div>
    )
}
